...
#             if "GUM_news_expo.conll" in pred_file:
#                 continue
            ...
            recall_correct, recall_total, precision_correct, precision_total = official_conll_eval(gold_file_new, pred_file_new, metric)
